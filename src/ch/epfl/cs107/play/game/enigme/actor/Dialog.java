...
public class Dialog implements Graphics {
     ...
     */
    public Dialog(String text, String backgroundName, Area area, float displayTime) {
    ...
    public void resetDialog(String newText){
        this.text = newText;
        this.cursor = 0;
        // The next operation has been added to the default class
        displayTime *= 2;
        push();
    }
    ...
    /**
     * Getter for the display time of the dialog
     * @return (float) 
     */
